<header class="app-header">
    <a class="app-header__logo" href="#">Employee Dashboard</a>
    ...
    <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li class="dropdown">
            <a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fas fa-user fa-lg"></i></a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('employee.profile') }}"><i class="fa fa-user fa-lg"></i> Profile</a>
                </li>   
                <li>
                    <a href="{{ route('logout') }}" 
                    class="dropdown-item "
