    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <!-- /.col -->
                <div class="col-sm-6">
                     <a href="{{route('employee.expenses.create')}}" class="btn btn-primary pull-right">Add Expense <i class="fa fa-fw fa-lg fa-arrow-right"></i></a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                        <td>
                                            <a href="{{ route('employee.expenses.edit', $expense->id) }}" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></a>
